...
// ║                                                          ║
// ║  API calls (GRG/QKV-G/Search/DeFi/Identity)             ║
// ║    85% → HELM_TREASURY                                   ║
// ║    15% → referring agent wallet                          ║
// ║                                                          ║
...
contract QkvgEscrow is ReentrancyGuard, Ownable {
    ...
    /// API revenue split: 85% treasury, 15% referrer agent
    uint256 public constant TREASURY_SHARE_BP    = 8500;
    uint256 public constant REFERRER_SHARE_BP    = 1500;
